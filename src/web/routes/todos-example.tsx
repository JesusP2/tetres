...
export const Route = createFileRoute('/todos-example')({
...
function RouteComponent() {
  ...
  useEffect(() => {
    ...
    if (session.data?.session) {
      setUserId(session.data.session.userId);
      return;
    }
  ...
  return (
    <div className="font-mono min-h-screen flex justify-center items-center flex-col space-y-4">
      ...
      <div className="border border-gray-300 max-w-xs w-full">
        <TodoForm todos={todos} userId={userId} />
...
function TodoForm({ todos, userId }: { todos: Todo[], userId: string }) {
  return (
