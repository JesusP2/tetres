...
import { Command, CommandEmpty, CommandGroup, CommandItem } from "@web/components/ui/command";
...
import { useEditorStore } from "@web/store/editor-store";
import { useThemePresetStore } from "@/store/theme-preset-store";
import { ThemePreset } from "@web/types/theme";
import { getPresetThemeStyles } from "@web/utils/theme-preset-helper";
...
const presetNames = Object.keys(defaultPresets) as (keyof (typeof defaultPresets))[];
